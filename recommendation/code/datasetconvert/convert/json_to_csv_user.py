...
def get_row(line_contents, column_names, userId_c, businessId_c):
    ...
    for column_name in column_names:
        ...
        elif column_name == 'friends':
            new_line_value = []
            for user_val in line_value:
                new_line_value.append(userId_c.getUserId(user_val))
...
if __name__ == '__main__':
    ...
    column_names = ['user_id', 'review_count', 'average_stars', 'friends']
